...
<script type="text/javascript">
    ...
    const jstpl_code = '<div class="text-center"><p>Votre performance vous a donné droit à un code à entrer sur <a href="https://www.thefirstspine.fr/code">thefirstspine.fr/code</a> !</p><p><strong>${code}</strong></p></div>';
